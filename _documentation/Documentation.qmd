...
For trend analysis, we adopt an approximative variant of the **Mann–Kendall (MK) test**, a **non-parametric statistical test** used to detect the presence of a **monotonic trend** (increasing or decreasing) in a time series.
...
- Tie counts adjust the variance term. A **lossy counting** strategy tracks frequencies efficiently.

...
class InWindowMKTrendDetector:
    def __init__(self, verbose=False, t_digest_compression_delta=0.1):
        self.co_gt_trend_detector_t_digest = SimpleTDigest(t_digest_compression_delta);
        self.co_gt_trend_detector = MKTrendDetector(self.co_gt_trend_detector_t_digest);
        
        self.pt08_s1_co_trend_detector_t_digest = SimpleTDigest(t_digest_compression_delta);
        self.pt08_s1_co_trend_detector = MKTrendDetector(self.pt08_s1_co_trend_detector_t_digest);

        self.nmhc_gt_trend_detector_t_digest = SimpleTDigest(t_digest_compression_delta);
        self.nmhc_gt_trend_detector = MKTrendDetector(self.nmhc_gt_trend_detector_t_digest);

        self.c6h6_gt_trend_detector_t_digest = SimpleTDigest(t_digest_compression_delta);
        self.c6h6_gt_trend_detector = MKTrendDetector(self.c6h6_gt_trend_detector_t_digest);

        self.pt08_s2_nmhc_trend_detector_t_digest = SimpleTDigest(t_digest_compression_delta);
        self.pt08_s2_nmhc_trend_detector = MKTrendDetector(self.pt08_s2_nmhc_trend_detector_t_digest);

        self.nox_gt_trend_detector_t_digest = SimpleTDigest(t_digest_compression_delta);
        self.nox_gt_trend_detector = MKTrendDetector(self.nox_gt_trend_detector_t_digest);

        self.pt08_s3_nox_trend_detector_t_digest = SimpleTDigest(t_digest_compression_delta);
        self.pt08_s3_nox_trend_detector = MKTrendDetector(self.pt08_s3_nox_trend_detector_t_digest);    

        self.no2_gt_trend_detector_t_digest = SimpleTDigest(t_digest_compression_delta);
        self.no2_gt_trend_detector = MKTrendDetector(self.no2_gt_trend_detector_t_digest);

        self.pt08_s4_no2_trend_detector_t_digest = SimpleTDigest(t_digest_compression_delta);
        self.pt08_s4_no2_trend_detector = MKTrendDetector(self.pt08_s4_no2_trend_detector_t_digest);

        self.pt08_s5_o3_trend_detector_t_digest = SimpleTDigest(t_digest_compression_delta);
        self.pt08_s5_o3_trend_detector = MKTrendDetector(self.pt08_s5_o3_trend_detector_t_digest);  

        self.t_trend_detector_t_digest = SimpleTDigest(t_digest_compression_delta);
        self.t_trend_detector = MKTrendDetector(self.t_trend_detector_t_digest);
    
        self.ah_trend_detector_t_digest = SimpleTDigest(t_digest_compression_delta);
        self.ah_trend_detector = MKTrendDetector(self.ah_trend_detector_t_digest);
    
        self.rh_trend_detector_t_digest = SimpleTDigest(t_digest_compression_delta);
        self.rh_trend_detector = MKTrendDetector(self.rh_trend_detector_t_digest);
